export const HEADERS = ['Name', 'Reps', 'RPE', '1', '2', '3', 'Notes'];
...
export const FULL_BODY_DAY1 = {
  ...
  data: [
    ...
    },
    {
      ...
      rest: 2000,
      trackedSets: [[], [], []],
      notes: 'DRIVE YOUR PINKY INTO THE HANDLE HARDER THAN YOUR POINTER FINGER',
    },
  ],
};
...
export const FULL_BODY_DAY2 = {
  ...
  data: [
    ...
    },
    {
      ...
      rest: 2000,
      trackedSets: [[], [], []],
      notes: "FOCUS ON FLEXING YOUR SPINE, DON'T YANK YOUR HEAD WITH YOUR ARMS",
    },
    {
